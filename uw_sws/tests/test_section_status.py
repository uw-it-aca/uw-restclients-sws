...
class SWSTestSectionStatusData(TestCase):
    ...
    def test_json_data(self):
        ...
        self.assertEqual(section_status.json_data(), {
            ...
            'responsible_course_number': "",
            'responsible_curriculum_abbreviation': "",
            'responsible_section_id': "",
            'responsible_section_joint_current_enrollment': None,
            'responsible_section_joint_limit_estimate_enrollment': None,
            'responsible_section_joint_space_available': None,
            'room_capacity': 345,
            'sln': '12588',
            'space_available': 40,
        })
