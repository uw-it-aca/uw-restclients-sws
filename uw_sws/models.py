...
class Term(models.Model):
    ...
    registration_services_start = models.DateField(blank=True)
    registration_period1_start = models.DateField(blank=True)
    registration_period1_end = models.DateField(blank=True)
    registration_period2_start = models.DateField(blank=True)
    registration_period2_end = models.DateField(blank=True)
    registration_period3_start = models.DateField(blank=True)
    registration_period3_end = models.DateField(blank=True)
